...
TLidarGrabResult C3iroboticsLidar::analysisHealthInfo(CLidarPacket &lidar_packet)
{
    ...
    printf("[C3iroboticsLidar] Lidar error is %5.5d!\n", lidar_error );
    return LIDAR_GRAB_ERRO;
}
...
{
    double lidar_erro_speed = CLidarUnpacket::unpacketLidarSpeed(lidar_packet) *0.05;
